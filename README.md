...
الرحلة الآن 20 شاشة: Hero → قصتنا → La Vera Cucina → الفلسفة → مصنوعة باليد → بوابة المنيو → 9 أطباق → المشروبات → توقيع الشيف → المعرض → اطلب → الخاتمة (وفيها أزرار الطلب أيضاً).
